export default {
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Brandon Nifong, a full-stack developer and internet marketer.' },
      { property: 'og:image', content: '/logo-thumbnail.png' },
      { property: 'og:locale', content: 'en-US' },
      { property: 'og:type', content: 'website' },
      { property: 'og:title', content: 'Brandon Nifong – Log1x' },
      { property: 'og:description', content: 'Brandon Nifong, a full-stack developer and internet marketer.' },
      ...
      { name: 'twitter:description', content: 'Brandon Nifong, a full-stack developer and internet marketer.' },
